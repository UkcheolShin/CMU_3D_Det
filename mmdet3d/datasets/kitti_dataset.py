...
class KittiDataset(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        # TODO(soonminh): Get required information for bevf models here
        image_paths = []
        caminfos = []

        # HACK(soonminh): image_3 is not supported yet
        for camera in ['image_2']:
            intrinsic = P2[:3, :3]
        ...
        input_dict = dict(
            ...
            img_prefix=None,
            img_info=dict(filename=img_filename, intrinsic_4x4=intrinsic_4x4),
            # lidar2img=[lidar2img],    # For LSS
