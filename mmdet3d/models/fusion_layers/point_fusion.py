...
def point_sample(img_meta,
    ...
    # HACK(soonminh): This is already considered by modifying intrinsic
    ...
    coor_x, coor_y = torch.split(pts_2d, 1, dim=1)  # each is Nx1
...
class PointFusion(BaseModule):
    ...
    def __init__(self,
        ...
        self.randomized_fusion = randomized_fusion
